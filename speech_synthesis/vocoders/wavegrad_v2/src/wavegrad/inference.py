...
def main(args):
  spectrogram_files = glob(os.path.join(args.spectrogram_folder, '*.spec.npy'))
  save_dir = args.save_dir
  for spec_file in spectrogram_files:
    spec_name = spec_file.split("/")[-1].split(".spec.npy")[0]
    ...
    save_pth = os.path.join(save_dir, f"{spec_name}.wav")
    torchaudio.save(save_pth, audio.cpu(), sample_rate=sr)
...
if __name__ == '__main__':
  ...
  parser.add_argument('--spectrogram_folder',
