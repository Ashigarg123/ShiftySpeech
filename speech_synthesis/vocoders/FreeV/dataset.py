...
def get_dataset_filelist(input_training_wav_list, input_validation_wav_list):
    training_files = []
    # loading wavs from txt file (modified)
    with open(input_training_wav_list, 'r') as f:
        training_files = [line.strip() for line in f.readlines()]

    with open(input_validation_wav_list, 'r') as f:
