...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--save_dir', type=int, required=False, default=None, help='path to save the generated audios')
    ...
    with torch.no_grad():
        for i, text_fname in enumerate(texts):
            text, fname = text_fname.split("|")

            print(f'Synthesizing {i} text...{text} and saving as {fname}', end=' ')
